  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-center gap-2 text-gray-500 text-sm font-mono">#{rank}</div>
        <span className={`text-2xl font-bold font-mono ${scoreColor}`}>{job.score.toFixed(0)}</span>
      </div>
      <div>
